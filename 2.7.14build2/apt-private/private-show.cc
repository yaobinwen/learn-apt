                     ...
                     char const *Buffer, size_t Length, std::ostream &out)
{
  ...
  out << std::endl
      << "Description-md5: " << Desc.md5() << std::endl;
...
bool ShowPackage(CommandLine &CmdL) /*{{{*/
{
  ...
  APT::CacheSetHelper::VerSelector const select = _config->FindB("APT::Cache::AllVersions", true) ? APT::CacheSetHelper::ALL : APT::CacheSetHelper::CANDIDATE;
