...
static std::string getMooLine(time_t const timenow) /*{{{*/
{
  ...
  {
  case PACKAGEMANAGER:
    out << "Happy package management day!";
    break;
  case APPRECIATION:
    out << "Three moos for Debian!";
    break;
  case AGITATION:
    out << "Whoever needs milk, bows to the animal.";
    break;
  case AIRBORN:
    out << "It's a Bird ... It's a Plane ... It's Super Cow!";
    break;
  default:
    out << "Have you mooed today?";
    break;
  }
...
static bool DoMoo2(time_t const timenow) /*{{{*/
{
  ...
  {
    c1out << OutputInDepth(depth, " ") << "         \033[1;97m(\033[0;33m__\033[1;97m)\033[0m\n"
...
bool DoMoo(CommandLine &CmdL) /*{{{*/
{
  ...
  {
  case 1:
    return DoMoo1(timenow);
  case 2:
    return DoMoo2(timenow);
  case 3:
    return DoMoo3(timenow);
  case 4:
    return DoMooApril();
  default:
    return DoMoo1(timenow);
