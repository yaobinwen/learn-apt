...
{
  std::cout << "Usage: rred [options] -t input output patch-1 … patch-N\n"
...
class RredMethod : public aptMethod
{
  ...
  struct PDiffFile
  {
    ...
    PDiffFile(std::string const &FileName, HashStringList const &ExpectedHashes) : FileName(FileName), ExpectedHashes(ExpectedHashes) {}
  };
