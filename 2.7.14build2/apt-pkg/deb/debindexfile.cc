...
// Sources Index							/*{{{*/
debSourcesIndex::debSourcesIndex(IndexTarget const &Target, bool const Trusted) : pkgDebianIndexTargetFile(Target, Trusted), d(NULL)
{
}
...
/*}}}*/
// Packages Index							/*{{{*/
debPackagesIndex::debPackagesIndex(IndexTarget const &Target, bool const Trusted) : pkgDebianIndexTargetFile(Target, Trusted), d(NULL)
{
}
...
/*}}}*/
// Translation-* Index							/*{{{*/
debTranslationsIndex::debTranslationsIndex(IndexTarget const &Target) : pkgDebianIndexTargetFile(Target, true), d(NULL)
{
}
...
debStringPackageIndex::debStringPackageIndex(std::string const &content) : pkgDebianIndexRealFile("", false), d(NULL)
{
  FileFd fd;
