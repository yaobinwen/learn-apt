...
template <typename Interface, typename Master, typename iterator_type, typename container_iterator, typename container_value>
class Container_iterator_base : public Interface::template iterator_base<iterator_type>
{
  protected:
  ...
  inline iterator_type operator+=(typename container_iterator::difference_type const &n)
  {
    _iter += n;
    return static_cast<iterator_type &>(*this);
  }
...
class Container_const_iterator : public Container_iterator_base<Interface, Master, Container_const_iterator<Interface, Container, Master>, typename Container::const_iterator, typename Container::value_type>
{
  ...
  public:
  explicit Container_const_iterator(container_iterator i) : Container_iterator_base<Interface, Master, iterator_type, container_iterator, typename Container::value_type>(i) {}

  inline typename Container::value_type getType(void) const { return *this->_iter; }
};
template <class Interface, class Container, class Master>
class Container_iterator : public Container_iterator_base<Interface, Master, Container_iterator<Interface, Container, Master>, typename Container::iterator, typename Container::value_type>
{
  typedef Container_iterator<Interface, Container, Master> iterator_type;
  typedef typename Container::iterator container_iterator;

  public:
  explicit Container_iterator(container_iterator const &i) : Container_iterator_base<Interface, Master, iterator_type, container_iterator, typename Container::value_type>(i) {}
...
template <class Interface, class Container, class Master>
class Container_const_reverse_iterator : public Container_iterator_base<Interface, Master, Container_const_reverse_iterator<Interface, Container, Master>, typename Container::const_reverse_iterator, typename Container::value_type>
{
  ...
  public:
  explicit Container_const_reverse_iterator(container_iterator i) : Container_iterator_base<Interface, Master, iterator_type, container_iterator, typename Container::value_type>(i) {}

  inline typename Container::value_type getType(void) const { return *this->_iter; }
};
template <class Interface, class Container, class Master>
class Container_reverse_iterator : public Container_iterator_base<Interface, Master, Container_reverse_iterator<Interface, Container, Master>, typename Container::reverse_iterator, typename Container::value_type>
{
  ...
  public:
  explicit Container_reverse_iterator(container_iterator i) : Container_iterator_base<Interface, Master, iterator_type, container_iterator, typename Container::value_type>(i) {}

  operator typename Master::const_iterator() { return typename Master::const_iterator(this->_iter); }
  inline iterator_type &operator=(iterator_type const &i)
  {
    this->_iter = i._iter;
    return static_cast<iterator_type &>(*this);
  }
  inline iterator_type &operator=(container_iterator const &i)
  {
    this->_iter = i;
    return static_cast<iterator_type &>(*this);
  }
...
class APT_PUBLIC PackageContainer : public PackageContainerInterface
{ /*{{{*/
  ...
  template <class Cont>
  void insert(PackageContainer<Cont> const &pkgcont) { _cont.insert((typename Cont::const_iterator)pkgcont.begin(), (typename Cont::const_iterator)pkgcont.end()); }
  ...
  PackageContainer(Itr first, Itr last) : PackageContainerInterface(CacheSetHelper::UNKNOWN), _cont(first, last) {}
#if __cplusplus >= 201103L
  ...
  bool sort(Compare /*Comp*/) { return false; }
...
template <>
template <class Cont>
void PackageContainer<std::list<pkgCache::PkgIterator>>::insert(PackageContainer<Cont> const &pkgcont)
{
...
template <>
template <class Cont>
void PackageContainer<std::forward_list<pkgCache::PkgIterator>>::insert(PackageContainer<Cont> const &pkgcont)
{
  for (typename PackageContainer<Cont>::const_iterator p = pkgcont.begin(); p != pkgcont.end(); ++p)
    _cont.push_front(*p);
}
...
template <>
template <class Cont>
void PackageContainer<std::deque<pkgCache::PkgIterator>>::insert(PackageContainer<Cont> const &pkgcont)
{
  for (typename PackageContainer<Cont>::const_iterator p = pkgcont.begin(); p != pkgcont.end(); ++p)
    _cont.push_back(*p);
}
template <>
template <class Cont>
void PackageContainer<std::vector<pkgCache::PkgIterator>>::insert(PackageContainer<Cont> const &pkgcont)
{
  for (typename PackageContainer<Cont>::const_iterator p = pkgcont.begin(); p != pkgcont.end(); ++p)
    _cont.push_back(*p);
}
...
template <>
inline bool PackageContainer<std::list<pkgCache::PkgIterator>>::insert(pkgCache::PkgIterator const &P)
{
  if (P.end() == true)
    return false;
  _cont.push_back(P);
...
#if __cplusplus >= 201103L
template <>
inline bool PackageContainer<std::forward_list<pkgCache::PkgIterator>>::insert(pkgCache::PkgIterator const &P)
{
  if (P.end() == true)
    return false;
  _cont.push_front(P);
...
#endif
template <>
inline bool PackageContainer<std::deque<pkgCache::PkgIterator>>::insert(pkgCache::PkgIterator const &P)
{
  if (P.end() == true)
    return false;
  _cont.push_back(P);
...
template <>
inline bool PackageContainer<std::vector<pkgCache::PkgIterator>>::insert(pkgCache::PkgIterator const &P)
{
  if (P.end() == true)
    return false;
  _cont.push_back(P);
...
class APT_PUBLIC PackageUniverse : public PackageContainerInterface
{
  ...
  {
    public:
    explicit const_iterator(pkgCache::PkgIterator i) : Container_iterator_base<APT::PackageContainerInterface, PackageUniverse, PackageUniverse::const_iterator, pkgCache::PkgIterator, pkgCache::PkgIterator>(i) {}
...
/*}}}*/
template <class Container>
class APT_PUBLIC VersionContainer : public VersionContainerInterface
{ /*{{{*/
  ...
  template <class Cont>
  void insert(VersionContainer<Cont> const &vercont) { _cont.insert((typename Cont::const_iterator)vercont.begin(), (typename Cont::const_iterator)vercont.end()); }
  void insert(const_iterator begin, const_iterator end) { _cont.insert(begin, end); }
  bool empty() const APT_OVERRIDE { return _cont.empty(); }
  void clear() APT_OVERRIDE { return _cont.clear(); }
  size_t size() const APT_OVERRIDE { return _cont.size(); }
  ...
  template <typename Itr>
  VersionContainer(Itr first, Itr last) : VersionContainerInterface(), _cont(first, last) {}
#if __cplusplus >= 201103L
...
template <>
template <class Cont>
void VersionContainer<std::list<pkgCache::VerIterator>>::insert(VersionContainer<Cont> const &vercont)
{
...
template <>
template <class Cont>
void VersionContainer<std::forward_list<pkgCache::VerIterator>>::insert(VersionContainer<Cont> const &vercont)
{
  for (typename VersionContainer<Cont>::const_iterator v = vercont.begin(); v != vercont.end(); ++v)
    _cont.push_front(*v);
}
...
template <>
template <class Cont>
void VersionContainer<std::deque<pkgCache::VerIterator>>::insert(VersionContainer<Cont> const &vercont)
{
  for (typename VersionContainer<Cont>::const_iterator v = vercont.begin(); v != vercont.end(); ++v)
    _cont.push_back(*v);
}
template <>
template <class Cont>
void VersionContainer<std::vector<pkgCache::VerIterator>>::insert(VersionContainer<Cont> const &vercont)
{
  for (typename VersionContainer<Cont>::const_iterator v = vercont.begin(); v != vercont.end(); ++v)
    _cont.push_back(*v);
}
...
// specializations again and again - but we need to see them, so that library users can use them
template <>
inline bool VersionContainer<std::list<pkgCache::VerIterator>>::insert(pkgCache::VerIterator const &V)
{
  if (V.end() == true)
    return false;
  _cont.push_back(V);
...
#if __cplusplus >= 201103L
template <>
inline bool VersionContainer<std::forward_list<pkgCache::VerIterator>>::insert(pkgCache::VerIterator const &V)
{
  if (V.end() == true)
    return false;
  _cont.push_front(V);
...
#endif
template <>
inline bool VersionContainer<std::deque<pkgCache::VerIterator>>::insert(pkgCache::VerIterator const &V)
{
  if (V.end() == true)
    return false;
  _cont.push_back(V);
...
template <>
inline bool VersionContainer<std::vector<pkgCache::VerIterator>>::insert(pkgCache::VerIterator const &V)
{
  if (V.end() == true)
    return false;
  _cont.push_back(V);
